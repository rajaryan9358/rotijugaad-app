...
class VerifyAadharSheet extends StatefulWidget {
  final int? employeeId;

  const VerifyAadharSheet({super.key, this.employeeId});

  @override
  State<StatefulWidget> createState() => _VerifyAadharSheetState();
}

class _VerifyAadharSheetState extends State<VerifyAadharSheet> {
  ...
  Future<void> _requestOtp() async {
    ...
    try {
      final resp = await context.read<EmployeesProvider>().sendAadhaarOtp(
  ...
  Future<void> _verifyOtp() async {
    ...
    setState(() => _isSubmitting = true);
    try {
      final updated = await context.read<EmployeesProvider>().verifyAadhaarOtp(
        employeeId: employeeId,
        aadhaarNumber: a,
        otp: otp,
      );
